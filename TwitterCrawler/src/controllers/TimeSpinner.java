...
public class TimeSpinner extends Spinner<LocalTime> {
    ...
    public TimeSpinner(LocalTime time) {
        ...
        // two colons and only digits in between:                               ///LocalTime.now()
        TextFormatter<LocalTime> textFormatter = new TextFormatter<LocalTime>(localTimeConverter, LocalTime.of(0, 0, 0), c -> {
